...
if 'id="driver-registration-view"' not in html_content:
    if 'id="planner-view"' in html_content:
        html_content = html_content.replace('<div id="planner-view"', view_html + '\n    <div id="planner-view"')
        with open(html_path, 'w', encoding='utf-8') as f:
            f.write(html_content)
        print("Injected view successfully.")
    else:
        print("planner-view not found!")
else:
    print("driver-registration-view already exists.")
